...
// Next 15: params is a Promise during type-checking
    ...
    return (
      <div className="container-px mx-auto py-16">
        ...
        <p className="mt-2 text-black/60">
          The case study you requested does not exist.
        </p>
  ...
  return (
    <article className="bg-white">
      ...
      <section className="container-px mx-auto max-w-5xl py-12">
        <div className="mb-3">
          <Link href="/#work" className="text-sm text-black/60 hover:underline">
            ← Back to work
          </Link>
        </div>
        ...
        {proj.results?.length ? (
          <div className="mt-8">
            ...
            <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-3">
              {proj.results.map((r: { label: string; value: string }) => (
      ...
      {proj.gallery?.length ? (
        <section className="container-px mx-auto max-w-6xl pb-14">
          ...
          <div className="mt-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {proj.gallery.map((g: { src: string; alt: string }) => (
            ...
            <div className="flex gap-3">
              {proj.demo && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn bg-white text-[var(--ink-800)] hover:bg-white/90"
                >
                  View demo
                </a>
              )}
